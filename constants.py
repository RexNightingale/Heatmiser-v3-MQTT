...
hmDCBStructure[56] = [103, 'Monday:Time1:Hour', 1, 0 ,3, 'RO', 0, 23]   # Start Hour for Timer 1, range 0 to 23
hmDCBStructure[57] = [104, 'Monday:Time1:Min', 1, 0 ,3, 'RO', 0, 59]    # Start Minute for Timer 1, range 0 to 59
hmDCBStructure[58] = [105, 'Monday:Time1:Temp', 1, 0 ,3, 'RO', 0, 35]   # Target temperature for Timer 1, range 5 to 35
hmDCBStructure[59] = [106, 'Monday:Time2:Hour', 1, 0 ,3, 'RO', 0, 23]   # Start Hour for Timer 2, range 0 to 23
hmDCBStructure[60] = [107, 'Monday:Time2:Min', 1, 0 ,3, 'RO', 0, 59]    # Start Minute for Timer 2, range 0 to 59
hmDCBStructure[61] = [108, 'Monday:Time2:Temp', 1, 0 ,3, 'RO', 0, 35]   # Target temperature for Timer 2, range 5 to 35
hmDCBStructure[62] = [109, 'Monday:Time3:Hour', 1, 0 ,3, 'RO', 0, 23]   # Start Hour for Timer 3, range 0 to 23
hmDCBStructure[63] = [110, 'Monday:Time3:Min', 1, 0 ,3, 'RO', 0, 59]    # Start Minute for Timer 3, range 0 to 59
hmDCBStructure[64] = [111, 'Monday:Time3:Temp', 1, 0 ,3, 'RO', 0, 35]   # Target temperature for Timer 3, range 5 to 35
hmDCBStructure[65] = [112, 'Monday:Time4:Hour', 1, 0 ,3, 'RO', 0, 23]   # Start Hour for Timer 4, range 0 to 23
hmDCBStructure[66] = [113, 'Monday:Time4:Min', 1, 0 ,3, 'RO', 0, 59]    # Start Minute for Timer 4, range 0 to 59
hmDCBStructure[67] = [114, 'Monday:Time4:Temp', 1, 0 ,3, 'RO', 0, 35]   # Target temperature for Timer 4, range 5 to 35
