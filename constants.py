...
hmDCBStructure[31] = [47, 'Weekday:Time1:Hour', 1, 0 ,3, 'RO', 0, 23]   # Start Hour for Timer 1, range 0 to 23
hmDCBStructure[32] = [48, 'Weekday:Time1:Min', 1, 0 ,3, 'RO', 0, 59]    # Start Minute for Timer 1, range 0 to 59
hmDCBStructure[33] = [49, 'Weekday:Time1:Temp', 1, 0 ,3, 'RO', 0, 35]   # Target temperature for Timer 1, range 5 to 35
hmDCBStructure[31] = [50, 'Weekday:Time2:Hour', 1, 0 ,3, 'RO', 0, 23]   # Start Hour for Timer 2, range 0 to 23
hmDCBStructure[32] = [51, 'Weekday:Time2:Min', 1, 0 ,3, 'RO', 0, 59]    # Start Minute for Timer 2, range 0 to 59
hmDCBStructure[33] = [52, 'Weekday:Time2:Temp', 1, 0 ,3, 'RO', 0, 35]   # Target temperature for Timer 2, range 5 to 35
hmDCBStructure[34] = [53, 'Weekday:Time3:Hour', 1, 0 ,3, 'RO', 0, 23]   # Start Hour for Timer 3, range 0 to 23
hmDCBStructure[35] = [54, 'Weekday:Time3:Min', 1, 0 ,3, 'RO', 0, 59]    # Start Minute for Timer 3, range 0 to 59
hmDCBStructure[36] = [55, 'Weekday:Time3:Temp', 1, 0 ,3, 'RO', 0, 35]   # Target temperature for Timer 3, range 5 to 35
hmDCBStructure[37] = [56, 'Weekday:Time4:Hour', 1, 0 ,3, 'RO', 0, 23]   # Start Hour for Timer 4, range 0 to 23
hmDCBStructure[38] = [57, 'Weekday:Time4:Min', 1, 0 ,3, 'RO', 0, 59]    # Start Minute for Timer 4, range 0 to 59
hmDCBStructure[39] = [58, 'Weekday:Time4:Temp', 1, 0 ,3, 'RO', 0, 35]   # Target temperature for Timer 4, range 5 to 35
hmDCBStructure[40] = [59, 'Weekend:Time1:Hour', 1, 0 ,3, 'RO', 0, 23]   # Start Hour for Timer 1, range 0 to 23
hmDCBStructure[41] = [60, 'Weekend:Time1:Min', 1, 0 ,3, 'RO', 0, 59]    # Start Minute for Timer 1, range 0 to 59
hmDCBStructure[42] = [61, 'Weekend:Time1:Temp', 1, 0 ,3, 'RO', 0, 35]   # Target temperature for Timer 1, range 5 to 35
hmDCBStructure[43] = [62, 'Weekend:Time2:Hour', 1, 0 ,3, 'RO', 0, 23]   # Start Hour for Timer 2, range 0 to 23
hmDCBStructure[44] = [63, 'Weekend:Time2:Min', 1, 0 ,3, 'RO', 0, 59]    # Start Minute for Timer 2, range 0 to 59
hmDCBStructure[45] = [64, 'Weekend:Time2:Temp', 1, 0 ,3, 'RO', 0, 35]   # Target temperature for Timer 2, range 5 to 35
hmDCBStructure[46] = [65, 'Weekend:Time3:Hour', 1, 0 ,3, 'RO', 0, 23]   # Start Hour for Timer 3, range 0 to 23
hmDCBStructure[47] = [66, 'Weekend:Time3:Min', 1, 0 ,3, 'RO', 0, 59]    # Start Minute for Timer 3, range 0 to 59
hmDCBStructure[48] = [67, 'Weekend:Time3:Temp', 1, 0 ,3, 'RO', 0, 35]   # Target temperature for Timer 3, range 5 to 35
hmDCBStructure[49] = [68, 'Weekend:Time4:Hour', 1, 0 ,3, 'RO', 0, 23]   # Start Hour for Timer 4, range 0 to 23
hmDCBStructure[50] = [69, 'Weekend:Time4:Min', 1, 0 ,3, 'RO', 0, 59]    # Start Minute for Timer 4, range 0 to 59
hmDCBStructure[51] = [70, 'Weekend:Time4:Temp', 1, 0 ,3, 'RO', 0, 35]   # Target temperature for Timer 4, range 5 to 35
